...
public class BANKOUT extends JFrame {
	...
	private boolean Confirm(){return  JOptionPane.YES_OPTION == JOptionPane.showConfirmDialog(this, "Widthdraw RM "+AmountTextField.getText() +" from Bank?", "Bank Widthdrawal", JOptionPane.YES_NO_OPTION);		}
	...
	private void refreshData(){
		...
		protected Void doInBackground() throws Exception {
			List<Transactions> Transac = TransactionListing.getInstance().getTransSpecific(4);
	...
	private JComponent createEditor() {
		    ...
		    nameTextField.setText("Bank Widthdrawal");
