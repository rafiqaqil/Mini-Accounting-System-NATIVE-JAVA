...
public class AddLoan extends JFrame {
	...
	private boolean Confirm(){return  JOptionPane.YES_OPTION == JOptionPane.showConfirmDialog(this, "Add Loans from "+nameTextField.getText()+"with amount RM "+AmountTextField.getText() +"?", "Credit Sale", JOptionPane.YES_NO_OPTION);		}
	...
	private JComponent createEditor() {
		    ...
		    nameTextField.setText("LOAN NAME ");
