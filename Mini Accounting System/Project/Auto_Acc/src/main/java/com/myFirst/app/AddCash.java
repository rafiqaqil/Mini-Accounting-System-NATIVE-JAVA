...
public class AddCash extends JFrame {
	...
	private boolean Confirm(){return  JOptionPane.YES_OPTION == JOptionPane.showConfirmDialog(this, "Clear Sale?", "Credit Sale", JOptionPane.YES_NO_OPTION);		}
	...
	private void refreshData(){
		...
		protected Void doInBackground() throws Exception {
			List<Transactions> Transac = TransactionListing.getInstance().getTransSpecific(6);
	...
	private JComponent createEditor() {
		    ...
		    nameTextField.setText("ADD CASH");
