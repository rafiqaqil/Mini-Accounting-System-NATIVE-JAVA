...
public class OtherIncome extends JFrame {
	...
	private boolean Confirm(){return  JOptionPane.YES_OPTION == JOptionPane.showConfirmDialog(this, "Add Income?", "Other Income", JOptionPane.YES_NO_OPTION);		}
	...
	private void refreshData(){
		...
		protected Void doInBackground() throws Exception {
			List<Transactions> Transac = TransactionListing.getInstance().getTransSpecific(1.3);
	...
	private JComponent createEditor() {
		    ...
		    nameTextField.setText("Other Income / Revenue");
