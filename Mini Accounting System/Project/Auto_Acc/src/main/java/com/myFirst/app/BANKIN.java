...
public class BANKIN extends JFrame {
	...
	private boolean Confirm(){return  JOptionPane.YES_OPTION == JOptionPane.showConfirmDialog(this, "Deposit RM "+AmountTextField.getText() +" into Bank?", "Credit Sale", JOptionPane.YES_NO_OPTION);		}
	...
	private JComponent createEditor() {
		    ...
		    nameTextField.setText("Bank Deposit");
