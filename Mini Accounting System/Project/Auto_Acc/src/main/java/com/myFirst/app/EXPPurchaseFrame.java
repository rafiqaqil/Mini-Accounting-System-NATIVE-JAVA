...
public class EXPPurchaseFrame extends JFrame {


	private static final long serialVersionUID = 5344044360317872317L;
	...
	private void refreshData(){
		...
		protected Void doInBackground() throws Exception {
			List<Transactions> Transac = TransactionListing.getInstance().getTransSpecific(2.5);
